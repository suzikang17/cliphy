...
export interface MyPlaylistPreview {
  playlistId: string;
  title: string;
}

/** List the authenticated user's own playlists (max 50). */
export async function fetchMyPlaylists(accessToken: string): Promise<MyPlaylistPreview[]> {
